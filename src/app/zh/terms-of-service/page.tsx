...
const dictionary = legalDictionaries.zh;
...
export default function ChineseTermsOfServicePage() {
	return <LegalPage dictionary={dictionary} document={document} locale="zh" />;
}
